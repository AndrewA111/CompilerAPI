...
public class QuestionCompiler {
    ...
    public static void main(String[] args) {
        try {
            ...
            final String JUNIT_LOC = "junit-4.13.jar";
            final String HAMCREST_CORE_LOC = "hamcrest-core-1.3.jar";
            final String JACKSON_LOC = "jackson-core-2.11.1.jar" + cpSeparator +
            		"jackson-annotations-2.11.1.jar" + cpSeparator +
